...
DEFAULTS = {
    ...
    "SQM_PORT": "10001",
    "WEATHERLINK_HOST": "",
    "WEATHERLINK_INTERVAL": "30",
    "CLOUDWATCHER_HOST": "",
    "CLOUDWATCHER_INTERVAL": "30",
    ...
    "INSTRUMENT_CODE_WEATHERLINK": "wx-weatherlink",
...
def save_env(config: Dict[str, str]) -> bool:
    ...
    try:
        lines = [
            ...
            "",
            "# SQM-LE Sky Quality Meter",
            f'SQM_HOST={config.get("SQM_HOST", "")}',
            f'SQM_PORT={config.get("SQM_PORT", "10001")}',
            "",
            "# Davis WeatherLink Live",
            f'WEATHERLINK_HOST={config.get("WEATHERLINK_HOST", "")}',
            f'WEATHERLINK_INTERVAL={config.get("WEATHERLINK_INTERVAL", "30")}',
            "",
            "# AAG Cloudwatcher",
            f'CLOUDWATCHER_HOST={config.get("CLOUDWATCHER_HOST", "")}',
            f'CLOUDWATCHER_INTERVAL={config.get("CLOUDWATCHER_INTERVAL", "30")}',
            "",
            "# AllSky Camera",
            ...
            "",
            "# Instrument Codes",
            f'INSTRUMENT_CODE_SQM={config.get("INSTRUMENT_CODE_SQM", "sqm-primary")}',
            f'INSTRUMENT_CODE_WEATHERLINK={config.get("INSTRUMENT_CODE_WEATHERLINK", "wx-weatherlink")}',
            f'INSTRUMENT_CODE_CLOUDWATCHER={config.get("INSTRUMENT_CODE_CLOUDWATCHER", "cw-solo")}',
